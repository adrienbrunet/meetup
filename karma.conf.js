// Karma configuration
// Generated on Mon Nov 23 2015 14:50:30 GMT+0100 (CET)
...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      // TODO: Our angular files
      // TODO: check if django-angular files are loaded.
      // If no, we need to find a way to load them from the third app... ><
      'ui/static/',

      'djangular/js/django-angular.min.js',
    ...
    reporters: ['html', 'progress', 'dots', 'junit'],
